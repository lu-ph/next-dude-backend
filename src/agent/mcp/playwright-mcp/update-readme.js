...
const unknownCapabilities = [...new Set(tools.browserTools.map((tool) => tool.capability))].filter(
  (cap) => !knownCapabilities.has(cap),
)
...
for (const capability of Object.keys(capabilities)) {
  ...
  let filteredTools = tools.browserTools.filter(
    (tool) => tool.capability === capability && !tool.skillOnly,
  )
