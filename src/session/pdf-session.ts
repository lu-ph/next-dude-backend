...
export class PDFSessionManager {
  ...
  private constructor() {
    ...
    setInterval(() => this.cleanupExpiredSessions(30 * 60 * 1000), 10 * 60 * 1000);
  }
  ...
  public getOrCreateSession(sessionId: string, pdfName: string, absolutePath: string): PDFSession | null {
  ...
  public async loadInstance(session: PDFSession): Promise<pdfjs.PDFDocumentProxy> {
